...
public class UserBooking implements Serializable {
    ...
    public void setCategory_price(float category_price) {
    ...
    public void setBooking_flag(int booking_flag) {
    ...
    public void setBooking_timestamp(long booking_timestamp) {
    ...
    public float getCompletePercentages() {
        return completePercentages;
    }

    public void setCompletePercentages(float completePercentages) {
