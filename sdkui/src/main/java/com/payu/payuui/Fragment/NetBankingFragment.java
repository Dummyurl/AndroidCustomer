        ...
        if (netBankingList != null) {
            ...
            for (int i = 0; i < netBankingList.size(); i++) {
                ...
                switch (netBankingList.get(i).getBankCode()){
                    case "AXIB":
                        ((LinearLayout)view.findViewById(R.id.layout_axis)).setVisibility(View.GONE);
                        break;
                    case "HDFB":
                        ((LinearLayout)view.findViewById(R.id.layout_hdfc)).setVisibility(View.GONE);
                        break;
                    case "SBIB":
                        ((LinearLayout)view.findViewById(R.id.layout_sbi)).setVisibility(View.GONE);
                        break;
                    case "ICIB":
                        ((LinearLayout)view.findViewById(R.id.layout_icici)).setVisibility(View.GONE);
                        break;
                }
