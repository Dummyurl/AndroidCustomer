...
public class GetDiscountActivity extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        baseActivity.headerNameTV.setText("Get Discount");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.CTVBcopy:
                ...
                ProjectUtils.showLong(getActivity(), "Code Copy");
                break;
    ...
    public void share() {
        try {
            ...
            sharingIntent.putExtra(Intent.EXTRA_TEXT, "Hello, this is my Referral Code " + code);
            startActivity(Intent.createChooser(sharingIntent, "Fab Customer"));
        } catch (Exception e) {
            e.printStackTrace();
            ProjectUtils.showLong(getActivity(), "Opps!! It seems that you have not installed any sharing app.");
        }
